...
icon = Image.open("D:\Mohanapriya\GUVIAssignments\CAPSTONE\ProjectYouTubeData\.venv\Include\Image\Youtube_logo.png")
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Mohanapriya",
                   page_icon= icon,
                   layout= "wide",
...
client = pymongo.MongoClient("mongodb+srv://mohanapriyatv:Passcodeall@test1.hvjifyq.mongodb.net/?retryWrites=true&w=majority")
...
api_key = "AIzaSyB9hVxjEm2H-uJDkxJY5LRtdfesxB03iU4" 
...
def get_video_details(v_ids):
    ...
    for i in range(0, len(v_ids), 50):
        response = youtube.videos().list(
                    part="snippet,contentDetails,statistics",id=v_ids).execute()
...
if selected == "Home":
    # Title Image
    st.image("D:\Mohanapriya\GUVIAssignments\CAPSTONE\ProjectYouTubeData\.venv\Include\Image\title.png")
